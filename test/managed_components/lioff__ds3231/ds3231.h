...
extern esp_err_t ds3231_init_desc(i2c_dev_t *dev, i2c_port_t port, int sda_gpio, int scl_gpio);
extern esp_err_t ds3231_set_time(i2c_dev_t *dev, struct tm *time);
extern esp_err_t ds3231_get_raw_temp(i2c_dev_t *dev, int16_t *temp);
extern esp_err_t ds3231_get_temp_integer(i2c_dev_t *dev, int8_t *temp);
extern esp_err_t ds3231_get_temp_float(i2c_dev_t *dev, float *temp);
