...
esp_err_t i2c_dev_read(const i2c_dev_t *dev, uint8_t *out_data, size_t out_size, uint8_t *in_data, size_t in_size) {
...
esp_err_t i2c_dev_write(const i2c_dev_t *dev, uint8_t *out_reg, size_t out_reg_size, uint8_t *out_data, size_t out_size) {
...
esp_err_t i2c_dev_read_reg(const i2c_dev_t *dev, uint8_t reg, uint8_t *in_data, size_t in_size) {
    return i2c_dev_read(dev, &reg, 1, in_data, in_size);
}

esp_err_t i2c_dev_write_reg(const i2c_dev_t *dev, uint8_t reg, uint8_t *out_data, size_t out_size) {
